...
#'django-insecure-t2ejw_&5kjei4i6uytf10f@xk%6shdseeh^k4e-9=$04&j)idr'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []   #+ ['localhost', '127.0.0.1']  (if debug=falase)
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static')          #output to ~ static
STATIC_URL = 'static/'
STATICFILES_DIRS = [                                    #output from source
